/******************************************************************************
Based on Sparkfun's BQ27220 library
******************************************************************************/

#ifndef SparkFunBQ27220_h
#define SparkFunBQ27220_h
...
private:
	uint8_t _deviceAddress;  // Stores the BQ27220-G1A's I2C address
	...
	*/
	...
	bool modifyCapacity(uint16_t MemoryAddress, uint8_t *data);
...
extern BQ27220 lipo; // Use lipo.[] to interact with the library in an Arduino sketch
// Thanks for reading!
